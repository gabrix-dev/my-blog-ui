...
const StorySection = () => {
  return (
    <div className="mt-96 lg:px-20" id="story_section">
      ...
      <div className="lg:text-3xl text-md text-gray-600 text-center lg:text-left font-medium">
      ...
      />
      <div className="lg:text-3xl text-md text-gray-600 mt-5 font-medium leading-normal lg:text-left text-center">
      ...
      <Image
        ...
        style={{ width: "100%", height: "auto" }}
      />
      <div className="grid lg:grid-cols-2 lg:gap-x-6 grid-cols-1">
